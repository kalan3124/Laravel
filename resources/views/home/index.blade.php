...
<div id="subscribe-me" class="modal animated fade in" role="dialog" data-keyboard="true" tabindex="-1">
    <div class="newsletter-popup">
        <img class="offer" src={{asset("assets/images/newsbg.jpg")}} alt="offer">
                ...
                <div class="col-sm-6">
                    <ul class="header-top-right text-right">
                        ...
                        @if(Sentinel::check())
                            ...
                            <li class="cart" style="color: red"><b>Hello {{ Sentinel::getUser()->first_name }} {{ Sentinel::getUser()->last_name }}</b></li>
                        @else
            ...
            <nav class="navbar">
                ...
                <div class="collapse navbar-collapse js-navbar-collapse pull-right">
                    <ul id="menu" class="nav navbar-nav">
                        <li> <a href="/">Home</a></li>
                        <li> <a href="/shop_wise_sale">Shop</a></li>
            ...
            <div class="col-md-3 footer-block">
                <div class="content_footercms_right">
                    <div class="footer-contact">
                        <div class="footer-logo mb_40"> <a href="index.html"> <img src="assets/images/newlogo.png" alt="HealthCare"> </a> </div>
                        <ul>
